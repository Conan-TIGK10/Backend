  ...
  if (error.name === "BLLException") {
    ...
    switch (errno) {
      case DALException.errorNumbers.DATETIME_FORMAT_ER:
        ...
        errStatusCode = BLLException.errorStatusCodes.DATETIME_ER;
        break;
